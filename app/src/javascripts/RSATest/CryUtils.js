...
exports.encryptWithBuffer = (dataBuffer,key) => {
    return crypto.publicEncrypt(key,dataBuffer);
}
;
...
exports.privKey = key.exportKey('pkcs1-private-pem');
exports.pubKey = key.exportKey('pkcs1-public-pem');
